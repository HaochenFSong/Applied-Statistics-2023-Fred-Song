...
mod1 <- stan(data = stan_data, file = 'model1.stan')
```
...
mod2 <- stan(data = stan_data, file = 'model2.stan')
```
## Model 3:
...
mod3 <- stan(data = stan_data, file = 'model3.stan')
```
...
P.S. I sent the code to Philip because he forgot to bring his laptop...just in case our answers look very similar :D
